...
class _DetailPageState extends State<DetailPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar:PreferredSize(preferredSize: Size(double.infinity,15), child:Container()),
      body: Container(
        ...
        child: Stack(
          children: [
            ...
            SizedBox(height: 10,),
                  Hero(tag: '${widget.aIndex}',child: Image.network(widget.productModel.image!,width: 210,height:200,)),
            SizedBox(height: 10,),
                  /// slider container
                  Row(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ButtonCoustomPage(width: 95.00, height: 30.00, color:Colors.orange, child: Center(child: Text("Discription",style: mTextStyle13(mFontColor: Colors.white,mFontWeigh:FontWeight.normal),))),
                          ButtonCoustomPage(width: 95.00, height: 30.00, color: Colors.white, child: Center(child: Text("Spacification",style:mTextStyle13(mFontWeigh:FontWeight.normal),))),
                          ButtonCoustomPage(width: 95.00, height: 30.00, color: Colors.white, child: Center(child: Text("Reviews",style: mTextStyle13(mFontWeigh: FontWeight.normal),))),
