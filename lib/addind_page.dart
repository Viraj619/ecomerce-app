           ...
           Column(
             children: [
               ...
               Row(
                 ...
                 children: [
                   CircleCoustomPage(width: 30.00, height: 30.00, imgurl: "",color: Colors.grey.withOpacity(0.2),child:IconButton(
                     onPressed: (){
                       Navigator.pop(context);
                     },icon:Center(child: Icon(Icons.arrow_back_ios,size: 15,color: Colors.black,)) ,
                   ) ,),
                   SizedBox(width: 100,),
                   CircleCoustomPage(width: 30.00, height: 30.00, imgurl: "",color: Colors.grey.withOpacity(0.2),child: IconButton(onPressed:(){

                   }, icon: Center(child: Icon(Icons.share,size: 15,color: Colors.black,))),),
                   CircleCoustomPage(width: 30.00, height: 30.00, imgurl: "",color: Colors.grey.withOpacity(0.2),child: IconButton(onPressed: (){

                   }, icon: Center(child: Icon(Icons.favorite_border,size: 15,color: Colors.black,))),)
                 ],
               ),
               SizedBox(height: 10,),
               Container(
                           ...
                           child: Padding(
                             ...
                             child: Column(
                               ...
                               children: [
                                 ...
                                 Row(
                                   children: [
                                     CircleCoustomPage(width: 30.00, height: 30.00, imgurl:"",color: Colors.red,child: Container(),),
                                     SizedBox(width: 10,),
                                     CircleCoustomPage(width: 30.00, height: 30.00, imgurl: "", color:Colors.black,child: Container(),),
                                     SizedBox(width: 10,),
                                     CircleCoustomPage(width: 30.00, height: 30.00, imgurl: "", color:Colors.blueAccent,child: Container()),
                                     SizedBox(width: 10,),
                                     CircleCoustomPage(width: 30.00, height: 30.00, imgurl: "", color:Colors.redAccent,child: Container()),
                                     SizedBox(width: 10,),
                                     CircleCoustomPage(width: 30.00, height: 30.00, imgurl: "", color:Colors.grey,child: Container())
                                   ],
                                 ),
                                // SizedBox(height: 10,),
                                 /// description
